            ...
            <div class="col">
                @if ($ae_status == 0)
                    <div class="p-3"> 
                        ...
                        <br>
                        <h2>Abre tu cuenta de ahorros y participa por <br><b>dos entradas a la final de la Liga Pro.</b></h2>
                        <img src="{{asset('/Imgs/vs.png')}}" alt="" width="30%" >
                        <br>
                        <h3>Por cada socio que refieras <b>TRIPLICA</b> tu oportunidad de ganar <br>
                            Abre tu cuenta con $25 y <b>TRIPLICA</b> tu oportunidad de ganar</h3>
                        <br>
                ...
                @elseif($ae_status == 1)
                    <div class="p-3"> 
                        ...
                        <br>
                        <h5>Por cada socio que refieras <b>TRIPLICA</b> tu oportunidad de ganar <br>
                            Abre tu cuenta con $25 y <b>TRIPLICA</b> tu oportunidad de ganar</h5>
                    </div>
                @elseif($ae_status == 2)
                    <div class="p-3"> 
                        <h5><b>¡Participa hasta el 12 de noviembre!</b></h5>
                ...
                @elseif($ae_status == 17)
                    <div class="p-3"> 
                        <h5><b>¡Participa hasta el 12 de noviembre!</b></h5>
                        <br>
                        <h2><b>14.- Agrega el comprobante del deposito inicial *</b></h2>
                        <br>
                        <div class="d-grid gap-2 col-6 mx-auto">
                            <input type="file" class="form-control" id="ticket" name="ticketName" wire:model='ae_urlTicket' >
                            @error('ae_urlTicket') 
                            <h5 ><b><i style="color: red;">*** {{$message}} ***</i></b></h5>
                            @enderror
                            <div wire:loading wire:target="ae_urlTicket">Cargando...</div>
                            <center>
                                @if ($ae_urlTicket)
                                    <br>
                                    <h5 ><b><i>Vista previa del comprobante:</i></b></h5>
                                    <br>
                                    <img src="{{ $ae_urlTicket->temporaryUrl() }}" width="50%">
                                @endif
                            </center>
                ...
                @elseif($ae_status == 18)
                        <div class="p-3"> 
                            <h4><b>¡Participa hasta el 12 de noviembre!</b></h4>
                            <br>
                            <h2><b>Gracias por formar parte de BOGA <br> ¡Ya estas participando!</b></h2>
                            <br>
                            <img src="Imgs/complete.gif" alt="" width="10%" >
                            <br>
                            <br>
                            <h4>Por cada socio que refieras <b>TRIPLICA</b> tu oportunidad de ganar <br>
                                Abre tu cuenta con $25 y <b>TRIPLICA</b> tu oportunidad de ganar</h4>
                        </div>
                @endif
            </div>
        </div>
